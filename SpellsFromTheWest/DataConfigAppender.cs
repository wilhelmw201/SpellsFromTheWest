...
namespace SpellsFromTheWest
{
    ...
    {
        public static SpecialEffectItem CreateAndAppendSpecialEffectItemFromStrings(string SkillTemplateId,
            ...
            string AffectRequirePower = "[]")
        {
            ...
            DataConfigAppenderHelpers.AddSpecialEffectItemToConfig(TemplateId, Name + SkillTemplateId, Item);

            CreateEffectObjHelper.RegisterSkillItem(int.Parse(SkillTemplateId) + 90000, ClassName);
            ...
            string RecoverBlockPercent = null, string OrderIdInSect = null)
        {
            ...
            CreateCombatSkillObjHelper.RegisterSkillItem(item);
        }
            ...
            string CombatSkillTemplateId, string LegacyPoint, string ReferenceBooksWithBonus)
        {
            ...
            CreateSkillBookObjHelper.CreatedBook(Item);
        }
