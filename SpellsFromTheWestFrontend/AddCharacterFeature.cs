...
namespace SpellsFromTheWest
{
	class  AddCharacterFeature
	{
        ...
        )
        {
            ...
            /*
            FieldInfo fieldInfo = typeof(Config.CharacterFeature).GetField("_extraDataMap", BindingFlags.NonPublic | BindingFlags.Instance);
            Dictionary<int, CharacterFeatureItem> ItemList = (Dictionary<int, CharacterFeatureItem>)fieldInfo.GetValue(Config.CharacterFeature.Instance);
            ItemList[TemplateId] = result;
